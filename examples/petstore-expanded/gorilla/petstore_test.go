...
import (
	...
	"github.com/debugger84/oapi-codegen/examples/petstore-expanded/gorilla/api"
	middleware "github.com/debugger84/oapi-codegen/pkg/chi-middleware"
...
func TestPetStore(t *testing.T) {
	...
	t.Run(
		"Find pet by ID", func(t *testing.T) {
			pet := api.Pet{
				Id: 100,
			}
	...
	t.Run(
		"Pet not found", func(t *testing.T) {
	...
	t.Run(
		"List all pets", func(t *testing.T) {
	...
	t.Run(
		"Filter pets by tag", func(t *testing.T) {
			tag := "TagOfFido"
